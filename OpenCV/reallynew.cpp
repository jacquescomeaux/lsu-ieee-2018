...
int main() {
  ...
  cv::Mat src, dst, img, gray_cont, imgHSV, mask, maskOpen, maskFinal, blankImg;
  cap >> src;
  ...
  for(auto cont : contours) {
    ...
    cv::dilate(gray_cont, gray_cont, cv::Mat());
    cv::Canny(gray_cont, gray_cont, 50, 150, 7);
    cv::HoughLinesP(gray_cont, gray_cont, 3, 3.141592/90, 100, 30, 100);
