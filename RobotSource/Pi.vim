...
silent only
cd ~/WorkingDirectory/RobotSource
...
badd +1 src/LED.cpp
badd +1 src/LineFollower.cpp
badd +1 src/MagnetArm.cpp
badd +1 src/ProximitySensor.cpp
badd +1 src/RGBSensor.cpp
badd +1 src/Robot.cpp
badd +1 src/SensorRing.cpp
badd +1 src/SerialLink.cpp
badd +1 src/SortingPlate.cpp
badd +1 src/SortingSystem.cpp
...
badd +16 include/LED.h
badd +1 include/LineFollower.h
badd +1 include/MagnetArm.h
badd +12 include/ProximitySensor.h
badd +14 include/RGBSensor.h
badd +1 include/Robot.h
badd +24 include/SensorRing.h
badd +1 include/SerialLink.h
badd +16 include/SortingPlate.h
badd +1 include/SortingSystem.h
...
silent! argdel *
$argadd src/main.cpp
$argadd src/Board.cpp
$argadd src/Camera.cpp
$argadd src/Controller.cpp
$argadd src/Coord.cpp
$argadd src/Drivetrain.cpp
$argadd src/LED.cpp
$argadd src/LineFollower.cpp
$argadd src/MagnetArm.cpp
$argadd src/ProximitySensor.cpp
$argadd src/RGBSensor.cpp
$argadd src/Robot.cpp
$argadd src/SensorRing.cpp
$argadd src/SerialLink.cpp
$argadd src/SortingPlate.cpp
$argadd src/SortingSystem.cpp
...
argglobal
3argu
if bufexists('include/Direction.h') | buffer include/Direction.h | else | edit include/Direction.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((19 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
argglobal
4argu
if bufexists('include/Controller.h') | buffer include/Controller.h | else | edit include/Controller.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((28 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
exe 'vert 1resize ' . ((&columns * 79 + 79) / 158)
exe 'vert 2resize ' . ((&columns * 78 + 79) / 158)
tabedit include/LineFollower.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
9argu
if bufexists('include/MagnetArm.h') | buffer include/MagnetArm.h | else | edit include/MagnetArm.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 79 + 79) / 158)
exe 'vert 2resize ' . ((&columns * 78 + 79) / 158)
tabedit include/SortingSystem.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((27 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
exe 'vert 2resize ' . ((&columns * 78 + 79) / 158)
argglobal
if bufexists('include/Token.h') | buffer include/Token.h | else | edit include/Token.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
