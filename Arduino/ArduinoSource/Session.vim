...
silent only
cd ~/WorkingDirectory/Arduino/ArduinoSource
...
badd +1 lib/MotorShield/MotorShield.h
badd +1 lib/ProximitySensor/ProximitySensor.h
...
badd +1 lib/LineSensor/LineSensor.cpp
badd +1 lib/MagnetArm/MagnetArm.cpp
badd +1 lib/MotorShield/MotorShield.cpp
badd +1 lib/ProximitySensor/ProximitySensor.cpp
...
silent! normal! zE
let s:l = 49 - ((26 * winheight(0) + 19) / 38)
...
wincmd w
argglobal
if bufexists('lib/LED/LED.h') | buffer lib/LED/LED.h | else | edit lib/LED/LED.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((25 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
wincmd w
argglobal
if bufexists('lib/LineSensor/LineSensor.h') | buffer lib/LineSensor/LineSensor.h | else | edit lib/LineSensor/LineSensor.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((20 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((22 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
